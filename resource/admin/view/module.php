            ...
            <div class="panel panel-default" id="menus">
                ...
                <if value="$moduleData">
                    <div class="panel-heading" role="button" data-toggle="collapse" href="#collapseExample"
                         aria-expanded="false" aria-controls="collapseExample"
                         style="border-top: 1px solid #ddd;border-radius: 0%">
                        <h4 class="panel-title">已安装模块</h4>
                        <a class="panel-collapse" data-toggle="collapse" href="#collapseExample" aria-expanded="true">
                            <i class="fa fa-chevron-circle-down"></i>
                        </a>
                    </div>
                    <ul class="list-group menus collapse in" id="collapseExample">
                        <foreach from="$moduleData" key="$k" value="$v">
                            <a href="index.php?action={{$v['module_name']}}/entry/index" class="list-group-item">
                                <i class="fa fa-list-ul" aria-hidden="true"></i>
                                <span class="pull-right" href=""></span>
                                {{$v['module_title']}}
                            </a>
...
<script>
    function run() {
        require(['hdjs'], function (hdjs) {
            hdjs.confirm('确定备份吗?', function () {
                location.href = "{{u('system.backup.run')}}";
            })
        })
    }
</script>
